...
impl WordlessApi 
{
    ...
    fn is_word_compatible_with_guess( test_word : &str, answer : &str, guess : &str) -> bool {
        ...
        { 
            ...
            if a == g
            {
                // reject test word if it does not have same letter here
                if t != g
                {
                    return false;
                }
            ...
            {
                // guess letter is present, but not in this column (it's "yellow")
                if t == g || !test_word.contains(g)
                {
                    // reject test word if guess matches this column, or guess letter is not present anywhere
                    return false;
                }
            }
            else
            {
                // guess letter is not present anywhere in answer
                if test_word.contains(g)
                {
                    // reject test word if guess letter IS present anywhere in the test word
                    return false;
                }
            }
       }   
